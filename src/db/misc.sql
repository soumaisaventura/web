...
UPDATE event
   SET background_color = '#444444'
 WHERE id = 1;

UPDATE event
   SET background_color = '#ff8a3d'
 WHERE id = 2;

UPDATE event
   SET background_color = '#fff493'
 WHERE id = 3;

UPDATE event
   SET background_color = '#10703d'
 WHERE id = 4;

UPDATE event
   SET background_color = '#7a4d3f'
 WHERE id = 5;

UPDATE event
   SET background_color = '#ff8860'
 WHERE id = 6;

UPDATE event
   SET background_color = '#2b2b2b'
 WHERE id = 10;

UPDATE event
   SET background_color = '#f92739'
 WHERE id = 7;

UPDATE event
   SET background_color = '#fbd6a3'
 WHERE id = 8;

UPDATE event
   SET background_color = '#f7f1ea'
 WHERE id = 9;

UPDATE event
   SET background_color = '#ffcd4e'
 WHERE id = 11;
 
UPDATE event
   SET background_color = '#353132'
 WHERE id = 12;